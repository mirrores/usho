...
<div class="m m_b14">
    ...
    <div class="hd_list w_780">
        <dl class="k_dl3">
            <dt><h1>所有活动</h1><em></em></dt>
            <dd>
                <ul>
                    <?php foreach ($list as $value) { ?>
                    <li><i></i><h1>[<a href="<?= Yii::app()->createUrl('alumni/view', array('id' => $value['alumni_id'])); ?>" target="_blank"><?=$value['alumni']['name']?></a>]<a target="_blank" href="<?= Yii::app()->createUrl('event/view', array('id' => $value['id'])); ?>"><?= $value['title'] ?></a></h1><span><?= substr($value['start_date'], 0, 10); ?></span></li>
                    <?php } ?>
                </ul>
                <!--page-->
                <div class="page_list">
