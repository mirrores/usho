        ...
        <div class="art_showdiv">
            ...
            <?php if (Yii::app()->user->id && $model->user_id == Yii::app()->user->id) { ?>
                <div class="alumni_tit" style="background:none;">
                    <a href="<?= Yii::app()->createUrl('talk/update', array('id' => $model['id'])); ?>" class="attention"><span>编辑话题</span></a>
                </div>
            <?php } ?>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#put_comment').click(function() {
            ...
            $.ajax({
                type: 'post',
                url: '<?= Yii::app()->createUrl('talkReply/ajaxAdd'); ?>',
                data: {'content': $('#comment').val(), 'quote_comment': $('#quote_comment').val(), 'is_anonymity': is_anonymity, 'talk_id':<?= $model['id']; ?>},
