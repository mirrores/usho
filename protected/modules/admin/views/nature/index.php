...
<tr align="center" bgcolor="#FAFAF1" height="22">
	<td width="6%">ID</td>
	<td width="10%">学校性质编码</td>
	<td width="15%">学校性质名称</td>
	<td width="10%">操作</td>
</tr>
<?php
     $i=1;
   foreach($records as $_n):
?>
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td align="center"><?php echo $i;?></td>
	<td align="center"><?php echo $_n->genre_code;?></td>
        <td align="center"><a href="<?=$this->createUrl('update',array("id"=>$_n->nature_id))?>"><?php echo $_n->nature_name;?></a></td>
	<td><a href="<?=$this->createUrl('update',array("id"=>$_n->nature_id));?>">编辑</a> | <a href="<?=$this->createUrl('delete',array("id"=>$_n->nature_id));?>">删除</a></td>
</tr>
<?php
    $i++;
endforeach;?>
