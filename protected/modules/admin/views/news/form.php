...
<div style="font-size: 13px;margin: 10px 5px">
    ...
    <table width="98%" border="0" cellpadding="2" cellspacing="1"  style="margin-top:8px" class="form_table">
        <tr>
            <td colspan="2" class="title"><?= $model->isNewRecord ? '添加' : '保存' ?>新闻</td>
        </tr>
        <tr>
            <td align="right">
        ...
        <tr>
            ...
            <td>
                <?= $form->dropDownList($model, 'category_id',CHtml::listData(Category::model()->findAll(), 'id', 'name')); ?> 
        ...
        <tr>
            ...
            <td>
                <?php echo $form->textField($model, 'title_color'); ?>
        ...
        <tr>
            ...
            <td>
                <?php echo $form->textField($model, 'images'); ?><br />
                ...
                <iframe  id="upfileframe" name="upfileframe" scrolling="no" style="width:500px; height:30px; display:inline" frameborder="0" src=" <?= $this->createUrl('/upload/img', array('no' => null, 'hidden_fieid' => 'News_images', 'msg' => '图片不大于2M', 'return_size_name' => 'thumbnail', 'prefix_path' => null)) ?>"></iframe>
                <?php echo $form->error($model, 'images'); ?>
                <?php if ($model->images) : ?>
                    <br /><img src="<?php echo Yii::app()->request->baseUrl . '/' . $model->images; ?>">
                <?php endif; ?>
            </td>
        </tr>
        <tr>
...
<?php
Common::ueditor('News_content');
?>

<script type="text/javascript">
    $("#News_alumni_id").autocomplete({
