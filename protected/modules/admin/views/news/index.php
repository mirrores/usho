<div id="page_head"> 
    <p class="title">新闻管理</p>
    <ul class="menu">
        <li><a href="<?= $this->createUrl('create')?>" class="btn btn-green">添加新闻</a></li>
    </ul>
</div>
...
<form name="form2">
    <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" style="margin-top:8px">
        ...
        <tr align="center" bgcolor="#FAFAF1" height="22">
            <td width="5%">ID</td>
            <td width="35%" style="padding-left: 20px; text-align: left">文章标题</td>
            <td width="5%">分类</td>
            <td width="20%">校友会</td>
            <td width="15%">创建时间</td>
            <td width="5%">置顶</td>
        ...
        <?php foreach ($records as $r): ?>
            <tr  bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor = '#FCFDEE';" onMouseOut="javascript:this.bgColor = '#FFFFFF';" height="22" >
                ...
                <td align="center"> <?= $r->category->name ?></td>
                <td align="center"><a href="<?=$this->createUrl('index',array("alumni_id" => $r->alumni_id))?>" title="查看该校友会所有新闻"><?= $r->alumni?$r->alumni->name:null ?></a></td>
                <td align="center"><?= ueTime($r['create_date']) ?></td>
                <td align="center"><?= $r['is_fixed'] == true ? '是' : '否' ?></td>
                <td align="center"><?= $r['is_release'] == true ? '是' : '否' ?></td>
