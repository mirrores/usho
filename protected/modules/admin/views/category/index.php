...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td align="center"><?php echo $_c->intro;?></td>
                 <td align="center"><?php echo $_c['is_public'] == true ? '是':'否' ?> </td>
	<td align="center"><a href="<?=$this->createUrl('update',array("id"=>$_c->id)) ;?>">编辑</a> | <a href="<?=$this->createUrl('delete',array("id"=>$_c->id));?>">删除</a></td>
</tr>
<?php
    $i++;
endforeach;?>
