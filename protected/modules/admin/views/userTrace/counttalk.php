        ...
        <tr align="center" bgcolor="#FAFAF1" height="22">
           ...
           <?php foreach($records as $value):?>
            ...
            <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.  = '#FCFDEE';" onMouseOut="javascript:this.bgColor = '#FFFFFF';" height="22" >
                  ...
                  <td><?=$value['talk']['id'];?></td>
                  <td><a href="<?=$this->createUrl('userTrace/TalkShow',array('id'=>$value['talk']['id']))?>"><?=$value['talk']['title'];?></a></td>
                  <td><?=  UserTrace::model()->count('controller="talk" and action="view" and data_id=:name',array(':name'=>$value['talk']['id']))?></td>
