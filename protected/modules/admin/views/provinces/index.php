...
<tr>
 <td height="26" background="<?php echo ADMIN_IMG_URL?>newlinebg3.gif">
  ...
  <tr>
  <td align="center">
      <a href="<?=$this->createUrl('create')?>" target="right">添加省份</a>
 </td>
 </tr>
</table>
</td>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td align="center"><?php echo $_p->id;?></td>
        <td align="center"> <a href="<?= $this->createUrl('update',array("id"=>$_p->id));?>"><?php echo $_p->name;?></td>
                <td align="center"><?php echo $_p->pinyin;?></td>
	<td><?php echo $_p->created_at;?></td>
                 <td><?php echo $_p->updated_at;?></td>
	<td><a href="<?=$this->createUrl('update',array("id"=>$_p->id));?>">编辑</a> | <a href="<?=$this->createUrl('delete',array("id"=> $_p->id));?>">删除</a></td>
</tr>
<?php endforeach;?>
