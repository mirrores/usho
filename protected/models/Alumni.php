...
class Alumni extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('school_id, is_recommend, news_count, month_news_count, event_count, month_event_count, weibo_count, month_weibo_count, month_rank, baidu_index', 'numerical', 'integerOnly' => true),
            array('name, weixin', 'length', 'max' => 100),
            array('website, logo_path, remark, keyword, erweima_path', 'length', 'max' => 255),
            array('weibo', 'length', 'max' => 22),
            array('introduction, create_date, update_date, last_collection_date', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, name, website, school_id, logo_path, introduction, remark, create_date, update_date, keyword, is_recommend, news_count, month_news_count, event_count, month_event_count, weibo_count, month_weibo_count, month_rank, baidu_index, last_collection_date, weixin, erweima_path, weibo', 'safe', 'on' => 'search'),
        );
    }
