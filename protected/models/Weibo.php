...
class Weibo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('weibo_sys_id, idstr, user_id, screen_name, created_at, id, mid, retweeted_status, repost_status, url, text, source, favorited, truncated, thumbnail_pic, bmiddle_pic, original_pic, reposts_count, comments_count, attitudes_count, pic_urls', 'safe', 'on'=>'search'),
		);
	}
